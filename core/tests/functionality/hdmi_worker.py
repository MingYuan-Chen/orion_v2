        ...
        if self.platform_name == 'athena':
            return [
                ...
                TestStep(
                    ...
                    pre_condition="Please ensure:\n1. HDMI cable is connected\n2. External display is powered on\n3. Camera connect to JigA or JigB",
                    post_check="Is camera display correctly on panel and monitor ?",
                    manual_only=True,
                    criteria="Camera display correctly on panel and monitor with good quality",
                )
            ]
        else:
            return [
