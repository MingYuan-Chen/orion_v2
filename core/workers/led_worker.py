...
class LedWorker(QObject):
    ...
    SET_LED_STATUS = {
        "athena": {
            ...
            "pic_control": "i2ctransfer -f -y 1 w4@0x4c 0x03 0x20 0x00 0x14 r1; sleep 0.1; i2ctransfer -f -y 1 w4@0x4c 0x03 0x22 0x00 0x20 r2"
        },
        "odin": {
            ...
            "pic_control": "i2ctransfer -f -y 2 w4@0x4c 0x03 0x20 0x00 0x14 r1; sleep 0.1; i2ctransfer -f -y 2 w4@0x4c 0x03 0x22 0x00 0x10 r2"
        },
        "argo": {
            ...
            "pic_control": "i2ctransfer -f -y 0 w4@0x4c 0x03 0x20 0x00 0x14 r1; sleep 0.1; i2ctransfer -f -y 0 w4@0x4c 0x03 0x22 0x00 0x10 r2"
        },
        "other": {
            "blue": "i2ctransfer -f -y 0 w4@0x4c 0x03 0x20 0x00 0x14 r1; sleep 0.1; i2ctransfer -f -y 0 w4@0x4c 0x03 0x22 0x00 0x01 r2",
            "green": "i2ctransfer -f -y 0 w4@0x4c 0x03 0x20 0x00 0x14 r1; sleep 0.1; i2ctransfer -f -y 0 w4@0x4c 0x03 0x22 0x00 0x02 r2",
        ...
        try:
            ...
            for line in response:
                if len(line) > 4 and line.startswith('0x'):
                    ...
                    self.led_status_updated.emit(f"{status} ({hex_value})")
        except Exception as e:
